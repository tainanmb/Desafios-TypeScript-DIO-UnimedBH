...
class HttpClient {
  static async get({url, method, body = null}:{url:string, method:string, body?:any} ) {//deixar any para o body por enquanto
...
async function procurarFilme(query:string): Promise<FilmesResult> {
...
// Fazendo a tipagem através de interface
