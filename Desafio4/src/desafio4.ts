...
//    - Busca filmes - OK
//    - Apresenta uma lista com os resultados pesquisados - OK
//    - Permite a criação de listas de filmes e a posterior adição de filmes nela - Falta implementar
...
class HttpClient {
  static async get({url, method, body = null}:{url:string; method:string, body?:any}) :Promise<any> {
